    ...
    fun createLazyProperty(
        ...
        return generateSimplePropertyWithBackingField(delegate, containingClass, delegate.name).apply {
            ...
            val initializerBody = builder.run {
                ...
                val lazyCall = irCall(lazyFunctionSymbol, targetIrType)
                lazyCall.putTypeArgument(0, targetIrType)
                lazyCall.putValueArgument(0, enumElement)
                lazyCall.putValueArgument(1, lambdaExpression)
