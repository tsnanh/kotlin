...
class GenerateProtoBufCompare {
    companion object {
        ...
        fun generate(destFile: File, failOnTeamcity: Boolean = true) {
            GeneratorsFileUtil.writeFileIfContentChanged(destFile, GenerateProtoBufCompare().generate(), failOnTeamcity = failOnTeamcity)
        }
    }
