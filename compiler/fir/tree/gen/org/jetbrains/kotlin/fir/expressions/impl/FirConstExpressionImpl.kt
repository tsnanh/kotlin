...
internal class FirConstExpressionImpl<T> (
    ...
    override fun <R, D> accept(visitor: FirVisitor<R, D>, data: D): R {
        ...
        return if (visitor is FirTransformer<D>) visitor.transformConstExpression(this, data) as R
        else visitor.visitConstExpression(this, data)
    }

    override fun <E : FirElement, D> transform(visitor: FirTransformer<D>, data: D): CompositeTransformResult<E> {
        @Suppress("UNCHECKED_CAST")
        return visitor.transformConstExpression(this, data) as CompositeTransformResult<E>
    }
