...
internal class FirThrowExpressionImpl(
    ...
    override fun <R, D> accept(visitor: FirVisitor<R, D>, data: D): R {
        ...
        return if (visitor is FirTransformer<D>) visitor.transformThrowExpression(this, data) as R
        else visitor.visitThrowExpression(this, data)
    }

    override fun <E : FirElement, D> transform(visitor: FirTransformer<D>, data: D): CompositeTransformResult<E> {
        @Suppress("UNCHECKED_CAST")
        return visitor.transformThrowExpression(this, data) as CompositeTransformResult<E>
    }
