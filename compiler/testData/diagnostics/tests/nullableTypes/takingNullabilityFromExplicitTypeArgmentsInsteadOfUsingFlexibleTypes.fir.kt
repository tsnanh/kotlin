...
class Bar<T, K: Any> {
    ...
    val foos16 = <!INAPPLICABLE_CANDIDATE!>J<!><Foo>()
    val foos17 = <!INAPPLICABLE_CANDIDATE!>J<!><Foo?>()
    val foos18 = <!INAPPLICABLE_CANDIDATE!>J<!><T>()
    val foos19 = <!INAPPLICABLE_CANDIDATE!>J<!><T?>()
}
