...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(SELF_CALL_IN_NESTED_OBJECT_CONSTRUCTOR_ERROR, "Self references to members of containing class are prohibited in constructor of nested object");
        ...
        MAP.put(INTEGER_OPERATOR_RESOLVE_WILL_CHANGE, "This expression will be resolved to {0} in futher releases. Please add explicit convention call", RENDER_TYPE);
