...
object NewSchemeOfIntegerOperatorResolutionChecker : CallChecker {
    override fun check(resolvedCall: ResolvedCall<*>, reportOn: PsiElement, context: CallCheckerContext) {
        if (context.languageVersionSettings.supportsFeature(LanguageFeature.SimplifiedIntegerLiteralOperatorResolution)) return
        ...
        for ((valueParameter, arguments) in resolvedCall.valueArguments) {
            ...
            for (argument in arguments.arguments) {
                ...
                val compileTimeValue = bindingContext[BindingContext.COMPILE_TIME_VALUE, expression] as? IntegerValueTypeConstant? ?: continue
                ...
                val approximatedType = valueTypeConstructor.possibleTypes.first()
