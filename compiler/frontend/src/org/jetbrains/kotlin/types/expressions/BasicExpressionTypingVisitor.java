...
public class BasicExpressionTypingVisitor extends ExpressionTypingVisitor {
    ...
    private void checkBinaryWithTypeRHS(
        ...
        if (context.languageVersionSettings.supportsFeature(LanguageFeature.StrongRestrictionsForAnnotationsOnTypes)) {
    ...
    private boolean evaluateIntegerConstantInIndependentMode(ExpressionTypingContext context) {
        return context.contextDependency == INDEPENDENT && context.languageVersionSettings.supportsFeature(LanguageFeature.SimplifiedIntegerLiteralOperatorResolution);
    }
}
